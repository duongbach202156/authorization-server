...
import com.example.authservice.model.entity.AuthorizationConsent;
...
@Component
public class JpaOAuth2AuthorizationConsentService implements AuthorizationConsentService {
    ...
    public JpaOAuth2AuthorizationConsentService(JpaAuthorizationConsentRepository authorizationConsentRepository, ClientRepository registeredClientRepository) {
