...
import com.example.authservice.model.entity.Authorization;
...
@Component
public class JpaOAuth2AuthorizationService implements AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(JpaAuthorizationRepository authorizationRepository, ClientRepository registeredClientRepository) {
